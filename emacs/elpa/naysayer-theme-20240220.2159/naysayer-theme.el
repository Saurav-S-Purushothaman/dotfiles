...
(let ((background "#062329")
  ...
  (custom-theme-set-faces
   ...
   `(region                           ((t (:distant-foreground "white" :background ,selection :extend t))))
   `(cursor                           ((t (:background ,white                        ))))
   `(fringe                           ((t (:background ,background   :foreground ,white))))
   `(linum                            ((t (:background ,background :foreground ,gutter-fg))))
   `(highlight                        ((t (:distant-foreground "white" :background ,selection))))
   ...
   ;; `(line-number-current-line ((t (:inherit default :foreground ,white :background ,background))))
   ...
   ;; helm
   `(helm-selection-line ((t (:foreground nil :background ,warning))))
   `(helm-selection ((t (:background ,warning :underline nil))))
